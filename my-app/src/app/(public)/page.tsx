...
const features:featuresprop[] = [{
   ...
   title:"Interactive Learning",
    ...
    description:"   Join a vibrant comunity of learners and iinstructors to collaborate and share knowledge",
    icon:"👥"
}]
  ...
  return (
    ...
    <section className="relative py-20">
        <div className="flex flex-col items-center text-center space-y-8">
            ...
            <p className="max-w-[700px] md:text-xl  text-muted-foreground">Discover a new way to learn with our modern,interactive learning management system. Access high-quality courses anytime, anywhere.</p>
    ...
    <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mb-32 gap-6">
